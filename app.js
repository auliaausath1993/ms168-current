var shop_name = "Modella Collection TGR"; // NAMA TOKO ONLINE
var domain_api = "modellacollection-tgr.com";
var token_api = "7a2470c3c31ac8079d9fcf849e03aefd";
var number_version = 36;
var domain = 'http://' + domain_api + '/mobile/'; // DOMAIN URL ADMIN
...
.run(function($ionicPlatform, $ionicLoading, $rootScope, $state, $ionicPopup, $ionicHistory, $http, productService, dataMessageService, dataPesananService) {
	...
	.then(function(res) {
		window.localStorage['number_version'] = number_version;
